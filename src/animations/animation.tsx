...
//Open menu
export const menuShow = (elem: any) => {
  gsap.from(elem, {
    duration: 0.7,
    height: 0,
...
//Close menu
export const menuHide = (elem: any) => {
  gsap.to(elem, {
    duration: 0.8,
    height: 0,
    ease: "power4.inOut",
...
//Stagger links
export const staggerLinks = (elem1: any, elem2: any, elem3: any) => {
...
//Skew gallery Images
export const skewGallery = (elem1: any) => {
